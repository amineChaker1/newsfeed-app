      ...
      <div className="header-left flex items-center">
        <div className="header-search flex p-1 items-center bg-blue-100 rounded-md h-10">
          ...
          <input
            placeholder="Search"
            type="text"
            className="  outline-none border-0 bg-blue-100"
          />
        </div>
      </div>
      <div className="header-right">
        <ul className="svgs flex items-center gap-2 md:gap-4">
          <a href="#">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <HeaderOption avatarImg={avatarImg} />
          <a onClick={LogoutOfApp} href="#">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
